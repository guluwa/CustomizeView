...
public class Practice14GetFontMetricsView extends View {
...

    {
        ...
        textYoffset = (fontMetrics.ascent + fontMetrics.descent) / 2;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(texts[0], 100, middle - textYoffset, paint2);
        canvas.drawText(texts[1], 200, middle - textYoffset, paint2);
        canvas.drawText(texts[2], 300, middle - textYoffset, paint2);
        canvas.drawText(texts[3], 400, middle - textYoffset, paint2);
        canvas.drawText(texts[4], 500, middle - textYoffset, paint2);
        canvas.drawText(texts[5], 600, middle - textYoffset, paint2);
    }
}
